...
puts 'Chapter 1:  Getting Started'.ljust(line_width - 7) + 'page  1'
puts 'Chapter 2:  Numbers'.ljust(line_width - 7) + 'page  9'
puts 'Chapter 3:  Letters'.ljust(line_width - 7) + 'page 13'
